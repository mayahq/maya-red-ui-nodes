...
;(function (global, factory) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (column.visible) {
        ...
        if (!ifVisible) {
          ...
          if (
            offset > 0 &&
            offset + colEl.offsetWidth < _this.element.clientWidth
          ) {
            return false
          }
        }
        ...
        left = Math.max(
          Math.min(
            left,
            _this.table.rowManager.element.scrollWidth -
              _this.table.rowManager.element.clientWidth
          ),
          0
        )
  ...
  Column.prototype.setField = function (field) {
    ...
    this.setFieldValue =
      this.fieldStructure.length > 1 ? this._setNesteData : this._setFlatData
  }
  ...
  Column.prototype._buildColumnHeader = function () {
    ...
    self.hozAlign =
      typeof self.definition.align == "undefined" ? "" : self.definition.align
  }
    ...
    return new Promise(function (resolve, reject) {
      if (rowIndex > -1) {
        ...
        if (position === "nearest") {
          switch (_this3.renderMode) {
            case "classic":
              ...
              position =
                Math.abs(_this3.element.scrollTop - rowTop) >
                Math.abs(
                  _this3.element.scrollTop +
            ...
            case "virtual":
              position =
                Math.abs(_this3.vDomTop - rowIndex) >
                Math.abs(_this3.vDomBottom - rowIndex)
                  ? "bottom"
                  : "top"
        ...
        if (!ifVisible) {
          if (Tabulator.prototype.helpers.elVisible(rowEl)) {
            offset =
              ...
              Tabulator.prototype.helpers.elOffset(_this3.element).top

            if (
              offset > 0 &&
              offset < _this3.element.clientHeight - rowEl.offsetHeight
            ) {
              return false
            }
          }
        ...
        switch (position) {
          ...
          case "center":
            _this3.element.scrollTop =
              _this3.element.scrollTop - _this3.element.clientHeight / 2
  ...
  RowManager.prototype.addRows = function (data, pos, index) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (_this5.table.options.groupBy && _this5.table.modExists("groupRows")) {
        ...
        _this5.table.options.pagination &&
        _this5.table.modExists("page")
      ) {
      ...
      if (_this5.table.modExists("columnCalcs")) {
        _this5.table.modules.columnCalcs.recalc(
          _this5.table.rowManager.activeRows
        )
      }
  ...
  RowManager.prototype._genRemoteRequest = function () {
    ...
    if (table.modExists("page")) {
      ...
      if (options.ajaxSorting) {
        ...
        params[self.table.modules.page.paginationDataSentNames.sorters] =
          sorters
      }
      ...
      if (options.ajaxFiltering) {
        ...
        params[self.table.modules.page.paginationDataSentNames.filters] =
          filters
      }
      ...
      case "page":
        if (!skipStage) {
          if (table.options.pagination && table.modExists("page")) {
            ...
            displayIndex = self.setDisplayRows(
              table.modules.page.getRows(this.getDisplayRows(displayIndex - 1)),
              displayIndex
            )
  ...
  RowManager.prototype.renderTable = function () {
    ...
    if (!self.displayRowsCount) {
      if (self.table.options.placeholder) {
        if (this.renderMode) {
          self.table.options.placeholder.setAttribute(
  ...
  Row.prototype.updateData = function (data) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (
        _this6.table.options.reactiveData &&
        _this6.table.modExists("reactiveData", true)
      ) {
      ...
      if (
        self.table.options.dataTree !== false &&
        self.table.modExists("dataTree") &&
        typeof data[_this6.table.modules.dataTree.getChildField()] !==
          "undefined"
      ) {
  ...
  Tabulator.prototype.defaultOptions = {
    ...
    pagination: "local", //set pagination type

    paginationSize: 10, //set number of rows to a page
  ...
  Tabulator.prototype._buildElement = function () {
    ...
    if (
      (options.persistentLayout ||
        options.persistentSort ||
        options.persistentFilter) &&
    ...
    if (
      (options.persistentSort || options.initialSort) &&
    ...
    if (
      (options.persistentFilter || options.initialFilter) &&
  ...
  Tabulator.prototype.copyToClipboard = function (
    selector,
    selectorParams,
    formatter,
    formatterParams
  ...
  Ajax.prototype._loadDataStandard = function (inPosition) {
    ...
    return new Promise(function (resolve, reject) {
      _this20
        ...
        .then(function (data) {
          _this20.table.rowManager
            .setData(data, inPosition)
            .then(function () {
              resolve()
            })
            .catch(function (e) {
  ...
  Clipboard.prototype.processConfig = function () {
    ...
    if (config.columnHeaders) {
      if (
        (config.columnHeaders === "groups" || config === true) &&
  ...
  Clipboard.prototype.copy = function (
    ...
    if (this.mode === true || this.mode === "copy") {
      ...
      this.copySelectorParams =
        typeof selectorParams != "undefined" && selectorParams != null
          ? selectorParams
          : this.config.columnHeaders
      this.setFormatter(formatter)
      this.copyFormatterParams =
        typeof formatterParams != "undefined" && formatterParams != null
          ? formatterParams
          : {}
  ...
  Clipboard.prototype.generateContent = function () {
    ...
    return this.copyFormatter.call(
      this,
      data,
      this.config,
      this.copyFormatterParams
  ...
  Clipboard.prototype.processColumnGroup = function (column) {
    ...
    if (subGroups.length) {
      ...
      if (
        column.field &&
        (column.definition.clipboard ||
          (column.visible && column.definition.clipboard !== false))
      ) {
        groupData.width = 1
      } else {
        return false
  ...
  Clipboard.prototype.buildOutput = function (rows, config, params) {
    ...
    if (config.columnHeaders) {
      if (config.columnHeaders == "groups") {
        columns = this.generateColumnGroupHeaders(
    ...
    if (config.rowGroups) {
      rows.forEach(function (row) {
        output = output.concat(
          _this26.parseRowGroupData(row, columns, config, params, calcs || {})
        )
      })
    } else {
  ...
  Clipboard.prototype.parseRowGroupData = function (
    group,
    columns,
    config,
    params,
    ...
    if (group.subGroups) {
      ...
      if (config.columnCalcs) {
        groupData = groupData.concat(
          this.getCalcRow(calcObj, columns, group.key, "top")
        )
      }

      groupData = groupData.concat(
        this.rowsToData(group.rows, columns, config, params)
      )

      if (config.columnCalcs) {
        groupData = groupData.concat(
          this.getCalcRow(calcObj, columns, group.key, "bottom")
        )
      }
    }
  ...
  Clipboard.prototype.generateHTML = function (
    rows,
    columns,
    calcs,
    config,
    ...
    self.mapElementStyles(this.table.element, this.htmlElement, [
      "border-top",
      "border-left",
      "border-right",
      "border-bottom",
    ...
    function generateSimpleHeaders() {
      ...
      columns.forEach(function (column) {
        ...
        self.mapElementStyles(column.getElement(), columnEl, [
          "border-top",
          "border-left",
          "border-right",
          "border-bottom",
      ...
      self.mapElementStyles(
        self.table.columnManager.getHeadersElement(),
        headerEl,
        [
          "border-top",
          "border-left",
      ...
      self.htmlElement.appendChild(
        document.createElement("thead").appendChild(headerEl)
      )
    }
    ...
    function generateHeaders(headers) {
      ...
      headers.forEach(function (columns) {
        ...
        columns.forEach(function (column) {
          ...
          self.mapElementStyles(column.element, columnEl, [
            "border-top",
            "border-left",
            "border-right",
            "border-bottom",
      ...
      rowArray.forEach(function (row, i) {
        ...
        columns.forEach(function (column, j) {
          ...
          if (j < columns.length - 1) {
            if (firstCell) {
              self.mapElementStyles(firstCell, cellEl, [
                "border-top",
                "border-left",
                "border-right",
                "border-bottom",
        ...
        if (styleRow) {
          self.mapElementStyles(styleRow, rowEl, [
            "border-top",
            "border-left",
            "border-right",
            "border-bottom",
    ...
    function processGroup(group, calcObj) {
      ...
      self.mapElementStyles(firstGroup, groupEl, [
        "border-top",
        "border-left",
        "border-right",
        "border-bottom",
  ...
  Clipboard.prototype.copySelectors = {
    ...
    table: function table(config, params) {
      ...
      return this.buildOutput(
        this.table.rowManager.getComponents(),
        config,
        params
      )
    },
  ...
  DataTree.prototype.generateChildren = function (row) {
    ...
    childArray.forEach(function (childData) {
      ...
      if (childRow.modules.dataTree.children) {
        childRow.modules.dataTree.open = _this31.startOpen(
  ...
  Filter.prototype.generateHeaderFilterElement = function (
    ...
    if (
      ...
      var oldFilterElementIndex =
        self.headerFilterElements.indexOf(oldFilterElement)
  ...
  Format.prototype.formatters = {
    ...
    progress: function progress(cell, formatterParams, onRendered) {
      ...
      return (
        "<div style='position:relative; height:100%;'  data-max='" +
        max +
        "' data-min='" +
        min +
        "'><div style='position:relative; min-height:20px; height:100%; width:calc(" +
        percentValue +
        "%); background-color:" +
        color +
  ...
  FrozenColumns.prototype.layoutColumnPosition = function (allCells) {
    ...
    this.leftColumns.forEach(function (column, i) {
      column.modules.frozen.margin =
        _this39._calcSpace(_this39.leftColumns, i) +
        _this39.table.columnManager.scrollLeft +
        "px"
    ...
    this.rightColumns.forEach(function (column, i) {
      column.modules.frozen.margin =
        _this39.rightPadding -
        _this39._calcSpace(_this39.rightColumns, i + 1) +
        "px"
  ...
  HtmlTableExport.prototype.genereateTable = function (
    config,
    style,
    visible,
    colVisProp
  ...
  HtmlTableExport.prototype.generateHeaderElements = function () {
    ...
    rows.forEach(function (row) {
      ...
      _this44.mapElementStyles(
        _this44.table.columnManager.getHeadersElement(),
        headerEl,
        [
          "border-top",
          "border-left",
      ...
      row.forEach(function (column) {
        ...
        _this44.mapElementStyles(column.column.getElement(), cellEl, [
          "text-align",
          "border-top",
          "border-left",
          "border-right",
        ...
        _this44.mapElementStyles(column.column.contentElement, cellEl, [
          "padding-top",
          "padding-left",
          "padding-right",
          "padding-bottom",
        ...
        if (column.column.parent) {
          _this44.mapElementStyles(column.column.parent.groupElement, cellEl, [
            "border-top",
          ])
        }
    ...
    rows.forEach(function (row, i) {
      ...
      switch (row.type) {
        case "group":
          ...
          _this45.mapElementStyles(firstGroup, rowEl, [
            "border-top",
            "border-left",
            "border-right",
            "border-bottom",
          ...
          _this45.mapElementStyles(firstGroup, cellEl, [
            "padding-top",
            "padding-left",
            "padding-right",
            "padding-bottom",
        ...
        case "row":
          columns.forEach(function (column) {
            ...
            if (firstCell) {
              _this45.mapElementStyles(firstCell, cellEl, [
                "padding-top",
                "padding-left",
                "padding-right",
                "padding-bottom",
          ...
          _this45.mapElementStyles(styleRow, rowEl, [
            "border-top",
            "border-left",
            "border-right",
            "border-bottom",
        ...
        if (this.table.modExists("clipboard", true)) {
          this.table.modules.clipboard.copy(
            !this.table.options.selectable ||
              this.table.options.selectable == "highlight"
              ? "active"
              : "selected",
            null,
            null,
  ...
  MoveColumns.prototype._unbindMouseMove = function () {
    this.table.columnManager.columnsByIndex.forEach(function (column) {
      if (column.modules.moveColumn.mousemove) {
        column
          .getElement()
          .removeEventListener("mousemove", column.modules.moveColumn.mousemove)
      }
    })
  }
    ...
    if (this.enabled) {
      self.table.columnManager.traverse(function (column) {
        ...
        if (column.modules.mutate) {
          mutator =
            column.modules.mutate[key] || column.modules.mutate.mutator || false
  ...
  Page.prototype.setPageToRow = function (row) {
    ...
    return new Promise(function (resolve, reject) {
      var rows = _this49.table.rowManager.getDisplayRows(
        _this49.displayIndex - 1
      )
    ...
    return new Promise(function (resolve, reject) {
      switch (_this52.mode) {
        case "local":
          ...
          _this52.table.options.pageLoaded.call(
            _this52.table,
            _this52.getPage()
          )
          resolve()
  ...
  Page.prototype._getRemotePage = function () {
    ...
    return new Promise(function (resolve, reject) {
      ...
      //set sort data if defined
      if (
        _this53.table.options.ajaxSorting &&
        _this53.table.modExists("sort")
      ) {
        var sorters = self.table.modules.sort.getSort()
      ...
      //set filter data if defined
      if (
        _this53.table.options.ajaxFiltering &&
        _this53.table.modExists("filter")
      ) {
        var filters = self.table.modules.filter.getFilters(true, true)
      ...
      self.table.modules.ajax
        .sendRequest(_this53.progressiveLoad)
        .then(function (data) {
  ...
  Persistence.prototype.retreiveData = function (type) {
    ...
    switch (this.mode) {
      ...
      default:
        console.warn(
          "Persistence Load Error - invalid mode selected",
          this.mode
        )
    }
  ...
  Persistence.prototype.saveData = function (id, data) {
    ...
    switch (this.mode) {
      ...
      case "cookie":
        ...
        //save cookie
        document.cookie =
          id + "=" + data + "; expires=" + expireDate.toUTCString()
        break

      default:
        console.warn(
          "Persistence Save Error - invalid mode selected",
          this.mode
        )
    }
  }
  ...
  Print.prototype.replaceTable = function () {
    if (!this.manualBlock) {
      ...
      this.element.appendChild(
        this.table.modules.htmlTableExport.genereateTable(
  ...
  Print.prototype.printFullscreen = function (visible, style, config) {
    var scrollX = window.scrollX,
      ...
      tableEl = this.table.modules.htmlTableExport.genereateTable(
        typeof config != "undefined" ? config : this.table.options.printConfig,
        typeof style != "undefined" ? style : this.table.options.printCopyStyle,
        visible,
        "print"
      ),
      headerContent,
  ...
  ResizeColumns.prototype._mouseDown = function (e, column, handle) {
    ...
    function mouseUp(e) {
      ...
      if (
        self.table.options.persistentLayout &&
  ...
  Sort.prototype.sort = function (data) {
    ...
    if (self.table.options.dataSorted) {
      self.table.options.dataSorted.call(
        self.table,
        self.getSort(),
        self.table.rowManager.getComponents(true)
      )
    }
  }
  ...
  Sort.prototype.sorters = {
    ...
    number: function number(a, b, aRow, bRow, column, dir, params) {
      ...
      a = parseFloat(
        String(a).split(thousand).join("").split(decimal).join(".")
      )
      b = parseFloat(
        String(b).split(thousand).join("").split(decimal).join(".")
      )
